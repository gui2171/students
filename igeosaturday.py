...
def main():
    ...
    if week_start_str in schedule:
        ...
        <body>
            <p>Dear Students,</p>
            <p>You did it, guys! We've finally made it to Saturday! Every great hero deserves a break, so take the weekend to rest and recharge. You've earned it!</b>.</p>
            <p>In this email, you won’t find any activities, only important information for next week.</p>
            <p>There are {days_left} days left until iGeo (July 28, 2025).</p>
            
            <p>For next week, please focus on the following:</p>
            <pre>{todos}</pre>
                <li>Study the basic concepts of {topic}.</li>
                <li>Review any relevant notes from previous sessions.</li>
            ...
            <p>Before I leave you to enjoy your weekend allow me to remind you this:</p>
            <p><b>{quote}</b></p>
