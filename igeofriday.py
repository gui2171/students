...
def main():
    ...
    if week_start_str in schedule:
        ...
        <body>
            <p>Dear Students,</p>
            <p>It's finally come guys!!! Today is the big day in which we are going to discuss {topic} </b>.</p>
            <p>{presenter} will be presenting today.</p>
            <p>There are {days_left} days left until iGeo (July 28, 2025).</p>
            
            <p>For this week, please focus on the following:</p>
            <pre>{todos}</pre>
            <p><b>Because today is Friday and therefore the big day, you guys have a lot to review from the previous emails, there is nothing new to read from this email. Please remember the following tasks:</b></p>
            ...
            <p>Have you prepared everything for Today's presentation and discussion?</p>
            <p>I am here if you need anything.</p>
            <p>Best regards,<br>Your Teamleader Guilherme S.</p>
            <p>Before I go for good and meet you in a couple hours I just wanted to remind you of this:</p>
            <p><b>{quote}</b></p>
            <p>Cheesy, right? The cheesiest things in life are the truest ones. Now, let's go get those Romanians!</p>
